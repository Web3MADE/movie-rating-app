...
export const data: IData = {
  movies: [
    ...
    },
    {
      ...
      plot: "A married couple are faced with a difficult decision - to improve the life of their child by moving to another country or to stay in Iran and look after a deteriorating p'a'rent who has Alzheimer's disease.",
      posterUrl:
